...
namespace Projeto6API.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class DestinoesController : ControllerBase
    {
        private readonly ViagensDBContexts _context;

        public DestinoesController(ViagensDBContexts context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Destino>> PostDestino(Destino destino)
        {
          if (_context.Destino == null)
          {
              return Problem("Entity set 'ViagensDBContexts.Destino'  is null.");
          }
